<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="90px">
      ...
      <el-form-item label="主治医师ID" style="width: 40%;">
        <el-input v-model="form.doctor" />
      </el-form-item>
      <el-form-item label="患者ID" style="width: 40%;">
      ...
      <el-form-item label="处方">
        <el-input v-model="form.prescription" clearable autosize type="textarea" />
      </el-form-item>
      <el-form-item label="治疗意见">
        <el-input v-model="form.opinion" clearable autosize type="textarea" />
      </el-form-item>
      <el-form-item>
