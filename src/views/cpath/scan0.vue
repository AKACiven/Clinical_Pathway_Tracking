  ...
  <div class="app-container">
        ...
        <template>
          ...
          <el-checkbox-group v-model="checkedCities.city1" @change="handleCheckedCitiesChange1">
            <el-checkbox v-for="city1 in cities.city1" :label="city1" :key="city1">{{ city1 }}
              <el-button @click="drawer0 = true" v-if="city1 === '饮食'" type="text" style="margin-left: 16px;">填写</el-button>
        ...
        <template>
          ...
          <el-checkbox-group v-model="checkedCities.city2" @change="handleCheckedCitiesChange2">
            <el-checkbox v-for="city2 in cities.city2" :label="city2" :key="city2">{{ city2 }}
              <el-button @click="drawer2 = true" v-if="city2.indexOf('常规检查') !== -1" type="text" style="margin-left: 16px;">选择</el-button>
              <el-button @click="drawer3 = true" v-if="city2.indexOf('功能性检查') !== -1" type="text" style="margin-left: 16px;">选择</el-button>
              <el-button @click="drawer4 = true" v-if="city2.indexOf('射线检查') !== -1" type="text" style="margin-left: 16px;">选择</el-button>
              <el-button @click="drawer5 = true" v-if="city2.indexOf('其他医嘱') !== -1" type="text" style="margin-left: 16px;">填写</el-button>
              <el-button @click="drawer6 = true" v-if="city2.indexOf('细化检查') !== -1" type="text" style="margin-left: 16px;">选择</el-button>
            </el-checkbox>
          </el-checkbox-group>
        </template>
      </el-collapse-item>
    ...
    <el-drawer
      ...
      <el-form label-width="20px">
        <el-form-item label="">
          <el-input v-model="detailCities.city1.input0" placeholder="请输入饮食医嘱" type="textarea" autosize style="width: 96%;"></el-input>
        </el-form-item>
      </el-form>
    </el-drawer>
    <el-drawer
      ...
      <el-form label-width="20px">
        <el-form-item label="">
          <el-input v-model="detailCities.city1.input1" placeholder="请输入医嘱内容" type="textarea" autosize style="width: 96%;"></el-input>
        </el-form-item>
      </el-form>
    </el-drawer>
    <el-drawer
