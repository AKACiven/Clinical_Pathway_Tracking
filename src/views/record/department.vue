<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column class-name="status-col" label="受理状态" prop="status" width="150" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="danger" size="mini" @click="takecharge(scope.row)">接手</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
